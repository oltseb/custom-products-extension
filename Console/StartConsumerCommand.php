 ...
 * *** IMPORTANT ***
 *
 * This is the copy of Magento's core Start ConsumerCommand declaration
 * In Magento 2.3.1 it is not displayed in the list
 */

namespace Oleksii\CustomProducts\Console;
...
class StartConsumerCommand extends Command
{
    ...
    const COMMAND_QUEUE_CONSUMERS_START = 'queue:consumers:start:oleksii';
